            ...
            <div className="container-custom">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {segments.map((segment, index) => (
                        ...
                        >
                            <div>
                                <h3 className="text-2xl font-extrabold text-gray-900 mb-1 group-hover:text-primary transition-colors">
                                    {segment.title}
                                </h3>
                            ...
                            <div className={`w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center ${segment.color} text-3xl transition-transform duration-500 group-hover:rotate-12`}>
